...
#include "HoldThenOngoing.generated.h"

UCLASS(NotBlueprintable, MinimalAPI, meta = (DisplayName = "Hold and then ongoing", NotInputConfigurable = "true"))
class UHoldThenOngoing : public UInputTrigger
{
    GENERATED_BODY()
